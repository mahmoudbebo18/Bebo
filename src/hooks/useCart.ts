...
const useCart = () => {
    ...
    const handleProceedToCheckout = useCallback(async () => {
        ...
        try {
            ...
            const payToken = await fetch("https://ecommerce-backend-mu-eight.vercel.app/api/paymob/auth", {
                method: "POST",
            });
            ...
            const orderRes = await fetch("https://ecommerce-backend-mu-eight.vercel.app/api/paymob/order", {
                method: "POST",
            ...
            const paymentKeyRes = await fetch("https://ecommerce-backend-mu-eight.vercel.app/api/paymob/payment-key", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
