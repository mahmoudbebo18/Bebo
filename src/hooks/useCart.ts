...
const useCart = () => {
    ...
    const handleProceedToCheckout = useCallback(async () => {
        ...
        try {
            ...
            const payToken = await fetch("http://localhost:5000/api/paymob/auth", {
                method: "POST",
            });
            ...
            const orderRes = await fetch("http://localhost:5000/api/paymob/order", {
                method: "POST",
            ...
            const paymentKeyRes = await fetch("http://localhost:5000/api/paymob/payment-key", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
